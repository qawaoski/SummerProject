...
<link rel="stylesheet" type="text/css" href="StyleSheets/TaskAssign.css" />
...
<body> 
 ...
 -->
    ...
    <h2 align="center"> Task Assignment:</h2>
    <table id="table1"; cellspacing="5px" cellpadding="5%"; align="center">
       <tr>
		              <td  align="right" class="apply">
              Task No.:
              		</td>
              <td><input type="text" name="Task_num" maxlength="7"/></td>
       </tr>
       <tr>
        		      <td align="right" class="apply">
        	   Task Description:
        ...
        <td>
              <textarea rows="3" cols="15" name="Description" maxlength="20"></textarea>
...
<!--               <input type="radio" name="attachemnt" value="Yes" />Yes
 ...
 <!--         </td>
  ...
  -->
        ...
        <td>
               <input type="text" name="Reg_by" maxlength="10" /> 
        </td>
       </tr>
       <tr>
              			<td align="right" class="apply">
 ...
 <!--              <input type="text" name="Status" maxlength="6"/> -->
       ...
       <tr>
        ...
        <td>
              <textarea rows="3" cols="15" name="Comments" maxlength="250"></textarea>
